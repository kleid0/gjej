...
export const STORES: Store[] = [
  {
    ...
    color: "#e63946",
    searchUrls: (q) => [`https://www.foleja.al/search?search=${encodeURIComponent(q)}`],
    selectors: {
      productLink: ["a.product-item-link", ".product-item-info a", "a.product-title", ".product-card a"],
      price: ["[data-price-type='finalPrice'] .price", ".special-price .price", ".price-box .price"],
      stock: [".stock", ".availability", "[class*='stock']"],
      inStockText: ["in stock", "në gjendje", "disponibël"],
      outOfStockText: ["out of stock", "jo në gjendje", "sold out"],
    },
  },
  {
    id: "shpresa",
    ...
    color: "#0066cc",
    searchUrls: (q) => [`https://shpresa.al/?s=${encodeURIComponent(q)}&post_type=product`],
    selectors: {
      productLink: ["a.product-item-link", ".product-name a", ".product-title a", "h3 a"],
